...
const OrbMaterial = shaderMaterial(
  ...
  `
    ...
    void main() {
      ...
      vPosition = position;
      vec3 p = position;
      p += normal * sin(time * 2.0 + position.y * 4.0) * 0.03;
  ...
  `
    ...
    void main() {
      ...
      float n = snoise(vec3(vPosition.xz * 2.0, time * 0.2));
      
      // Main color (bluish-green)
      vec3 color1 = vec3(0.0, 0.7, 0.7);
      // Secondary color (purple hint)
      ...
      finalColor += glow * vec3(0.1, 0.3, 0.3);
